...
Report.collection.dropIndex('studentInteractionID_1').catch(() => {
  // Ignore error if index doesn't exist
});

// Create new indexes
Report.collection.createIndex({ interactionID: 1 }, { unique: true });
Report.collection.createIndex({ studentNumber: 1, interactionTimestamp: -1 });
