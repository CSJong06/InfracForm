...
export default function ResolvedClient() {
  ...
  const { reports, loading, error, refresh } = useReports('RESOLVED');
      ...
      <main className="flex-1 flex flex-col p-6 sm:p-10 gap-10 relative overflow-x-auto">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Resolved Reports</h1>
